...
insert into PRODUCT(ID, VERSION, NAME, CATEGORY_ID, STOCK) values (2000, 0, 'Dell Optiplex 3010', 1002, 3);
insert into PRODUCT(ID, VERSION, NAME, CATEGORY_ID, STOCK) values (2001, 0, 'Dell Optiplex 3020', 1002, 5);
insert into PRODUCT(ID, VERSION, NAME, CATEGORY_ID, STOCK) values (2002, 0, 'Dell XPS', 1003, 10);
insert into PRODUCT(ID, VERSION, NAME, CATEGORY_ID, STOCK) values (2003, 0, 'Dell Latitude', 1003, 1);
insert into PRODUCT(ID, VERSION, NAME, CATEGORY_ID, STOCK) values (2004, 0, 'MS Windows 8', 1006, 2);
insert into PRODUCT(ID, VERSION, NAME, CATEGORY_ID, STOCK) values (2005, 0, 'MS Windows 10', 1006, 0);
insert into PRODUCT(ID, VERSION, NAME, CATEGORY_ID, STOCK) values (2006, 0, 'MS Office 2015', 1007, 4);
